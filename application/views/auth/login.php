        ...
        <div class="mx-1 my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <!-- <img class="col-lg-6 d-none d-lg-block" src="<?= base_url('assets/img/logo_bsi_baru.png'); ?>"> -->
              <img class="col-lg-6 d-none d-lg-block animated--grow-in" src="<?= base_url('assets/img/logo_bsi_baru.png'); ?>">
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4 font-weight-bold">Login</h1>
                    <h1 class="h4 text-gray-900 mb-4 font-weight-bold">Asset Management</h1>
                  </div>
